...
from baseline_admittance_control import run_baseline_admittance
...
from global_constants import normal_turn, slow_turn, normal_walk, slow_walk, test_force_controller
from global_constants import baseline_head

import time


def run_trajectory(action: List[Movement], speach: List[WordGraph], resistanceTracker: ResistanceTracker) -> None:
...
if __name__ == "__main__":
    ...
    demo_speach = [baseline_head]

    run_trajectory(demo_action, demo_speach,  test_force_controller)
